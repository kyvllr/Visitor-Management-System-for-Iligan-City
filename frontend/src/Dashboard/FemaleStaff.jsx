...
import ViewVisitorFemaleDivision from "./Components/Staff/ViewVisitorFemaleDivision";
  ...
  return (
      <div className="dashboard">
        ...
        <ul className="side-menu">
          {[
            { name: "Dashboard", icon: "bx bxs-dashboard", path: "/femalestaff/dashboard" },
            { name: "Recorded Visits", icon: "bx bxs-calendar-check", path: "/femalestaff/record-visits" },
            { name: "Visitors", icon: "bx bxs-user-voice", path: "/femalestaff/visitors" },
            { name: "Guests", icon: "bx bxs-user-badge", path: "/femalestaff/guest" },
            { name: "Reports", icon: "bx bxs-report", path: "/femalestaff/reports-analytics" },
          ].map((link, index) => (
            <li key={index}>
              <NavLink
                to={link.path}
      ...
      <div className="content">
        ...
        <nav className="fixed-nav">
          ...
          <Button 
            ...
            className="me-3"
            size="sm"
            style={{ backgroundColor: '#00b7ff', color: '#ffffff', fontWeight: '600', boxShadow: '0 0 15px rgba(0, 183, 255, 0.74)'  }}>
            <svg className="me-1" width="16" height="16" viewBox="0 0 24 24" fill="#ffffff">
            ...
            <Dropdown.Toggle variant="link" id="dropdown-profile">
              <div className="profile">
                ...
                <span className="profile-info">
                  <strong>{user?.name || 'Female Staff'}</strong>
                  <small>FEMALE STAFF</small>
                </span>
              </div>
            </Dropdown.Toggle>
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/visitors" element={<ViewVisitorFemaleDivision />} />
