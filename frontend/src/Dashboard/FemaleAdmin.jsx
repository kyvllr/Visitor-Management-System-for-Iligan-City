...
import VisitorFemaleDivision from "./Components/Admin/VisitorFemaleDivision";
import FemaleInmates from "./Components/Admin/FemaleInmates";
      ...
      <div className="content">
        ...
        <nav className="fixed-nav">
          ...
          <Button 
            ...
            className="me-3"
            size="sm"
            style={{ backgroundColor: '#00b7ff', color: '#000000', fontWeight: '600', boxShadow: '0 0 15px rgba(0, 255, 255, 0.74)' }}
            >
