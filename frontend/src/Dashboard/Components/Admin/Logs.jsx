...
const Logs = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const endpoints = [
        { url: `${API_BASE_URL}/users`, module: 'user' },
        { url: `${API_BASE_URL}/inmates`, module: 'inmate' },
        { url: `${API_BASE_URL}/visitors`, module: 'visitor' },
        { url: `${API_BASE_URL}/guests`, module: 'guest' },
        { url: `${API_BASE_URL}/crimes`, module: 'crime' },
        { url: `${API_BASE_URL}/visit-logs`, module: 'visit' },
        { url: `${API_BASE_URL}/pending-visitors`, module: 'visitor' },
        { url: `${API_BASE_URL}/pending-guests`, module: 'guest' }
      ];
