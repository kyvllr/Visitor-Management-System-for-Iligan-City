...
const INMATES_API_URL = `${API_BASE_URL}$1`;
const VISITORS_API_URL = `${API_BASE_URL}$1`;
const GUESTS_API_URL = `${API_BASE_URL}$1`;
const USERS_API_URL = `${API_BASE_URL}$1`;
const ACTIVE_TIMERS_URL = `${API_BASE_URL}$1`;
const VISIT_LOGS_URL = `${API_BASE_URL}$1`;
const ALL_ACTIVE_TIMERS_URL = `${API_BASE_URL}$1`; // For all active timers
