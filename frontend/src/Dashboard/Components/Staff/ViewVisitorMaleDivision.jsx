...
const ViewVisitorMaleDivision = () => {
  ...
  const filterVisitors = () => {
    ...
    // FIRST: Filter visitors to only show those connected to male PDL
  ...
  const handlePrisonerIdChange = (e) => {
    ...
    // Filter suggestions based on input - ONLY MALE PDL
    if (value.trim()) {
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <div className="text-muted small">
            Only showing visitors connected to male PDL
          </div>
        </div>
